...
class JsonResponse
{
    ...
    const MSG_CHOOSE_SUB_AND_CATEGORY = "choose_subCategory_and_category";
    const MSG_ADD_NEW_SUB = "add_new_sub_category";
    CONST MSG_QTY_NOT_AVAILABLE = "this_amount_of_product_not_available_now";
    const MSG_ALREADY_DISABELD= "this_order_already_disabled";
    const MSG_ALREADY_ENABLED= "this_order_already_enabled";
    const MSG_ALREADY_FAV = "this_coupon_already_in_favorites_list";

    const MSG_SUCCESS_IN_REVIEW = "register_in_review";
