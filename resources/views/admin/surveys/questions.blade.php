...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ {{trans('surveys/surveys.questions')}}
                </span>
            </div>
        </div>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="btn btn-primary btn-sm"
                           href="{{ route('survey.question.create', $survey->id) }}">{{trans('surveys/surveys.add_question')}}</a>
                    </div>
                    ...
                    <div class="table-responsive userlist-table">
                        <table class="table table-striped table-vcenter text-nowrap mb-0" id="example1">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">{{trans('surveys/surveys.type')}}</th>
                                <th class="wd-20p border-bottom-0">{{trans('surveys/surveys.created_at')}}</th>
                            ...
                            @foreach ($questions as $key => $question)
                                <tr id="row-{{$question->id}}">
                                    ...
                                    <td>{{trans('surveys/surveys.'.\App\Helpers\Constants::questionType[$question->questionType->type]) }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-sm" title="{{trans('general.Edit')}}"
                                           href="{{ route('survey.question.edit', $question->id) }}"><i
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"
                                                id="myModalLabel22">{{trans('surveys/surveys.desc')}}</h4>
    ...
    @section('scripts')
        ...
        <!-- Internal Data tables -->
            ...
            <script src="{{asset('assets/js/admin-pages/surveys/questions/list.js')}}"></script>
