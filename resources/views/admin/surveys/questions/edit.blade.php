    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ <a href="{{route('survey.students',  $question->survey->id)}}">{{$question->survey->title}}</a>
                </span>
                <span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ <a
                        href="{{route('survey.questions', $question->survey->id)}}">{{trans('questions/questions.questions')}}</a>
                </span>
                <span
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('survey.question.update', $question->id)}}" method="POST"
                        ...
                        <div class="row row-sm mt-2" id="option_div">
                            ...
                            @foreach($question->SurveyOptions as $option)
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/admin-pages/surveys/questions/edit.js')}}"></script>
