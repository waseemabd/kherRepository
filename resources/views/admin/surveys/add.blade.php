...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{route('survey.index')}}">{{trans('surveys/surveys.surveys')}}</a></h4><span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ {{trans('surveys/surveys.add_survey')}}</span>
            </div>
        </div>
...
{{--    <script src="{{asset('assets/js/advanced-form-elements.js')}}"></script>--}}
    ...
    <script src="{{asset('assets/js/admin-pages/surveys/add.js')}}"></script>
