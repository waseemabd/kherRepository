            ...
            <div class="d-flex">
                ...
                <span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ <a
                        href="{{route('test.show', $test->id)}}">{{$test->title}}</a>
                </span>
                <span
                    class="text-muted mt-1 tx-13 ms-2 mb-0">/ <a
                        href="{{route('test.questions', $test->id)}}">{{trans('questions/questions.questions')}}</a>
                </span>
                <span
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('test.question.store', $test->id)}}" method="POST"
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/admin-pages/questions/add.js')}}"></script>
