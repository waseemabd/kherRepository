                        ...
                        <div class="row row-sm mt-2">
                            <div class="col-md-6">
                                ...
                                <div class="input-group col-md-12">
                                    ...
                                    <input class="form-control date-input" id="datetimepicker" name="start_date" type="text" value="{{now()}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group col-md-12">
                                    ...
                                    <input class="form-control date-input" id="datetimepicker1" name="end_date" type="text" value="{{now()}}">
                                </div>
                            </div>
