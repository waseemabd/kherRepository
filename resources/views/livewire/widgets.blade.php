				...
				<div class="row row-sm">
						...
						<div class="card text-center">
							<div class="card-body ">
								<div class="feature widget-2 text-center mt-0 mb-3">
									<i class="ti-bar-chart project bg-primary-transparent mr-center text-primary "></i>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								<div class="feature widget-2 text-center mt-0 mb-3">
									<i class="ti-pie-chart project bg-pink-transparent mr-center text-pink "></i>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body">
								<div class="feature widget-2 text-center mt-0 mb-3">
									<i class="ti-pulse  project bg-teal-transparent mr-center text-teal "></i>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								<div class="feature widget-2 text-center mt-0 mb-3">
									<i class="ti-stats-up project bg-success-transparent mr-center text-success "></i>
								</div>
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									...
									<div class="wrapper w-100 ms-3">
										...
										<div class="d-sm-flex justify-content-between align-items-center">
											...
											<small class="text-muted ms-auto">2 ago hours</small>
										</div>
									</div>
								</div>
								<div class="list d-flex align-items-center border-bottom py-3">
									...
									<div class="wrapper w-100 ms-3">
										...
										<div class="d-sm-flex justify-content-between align-items-center">
											...
											<small class="text-muted ms-auto">3 ago hours</small>
										</div>
									</div>
								</div>
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image"
										data-bs-image-src="{{asset('assets/img/faces/14.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 ms-3">
										<p class="mb-0">
										...
										<div class="d-sm-flex justify-content-between align-items-center">
											...
											<small class="text-muted ms-auto">1 ago hours</small>
										</div>
									</div>
								</div>
