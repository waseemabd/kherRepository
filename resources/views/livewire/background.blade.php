					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card mg-b-20">
							<div class="card-body h-100">
								...
								<div class="example">
									<div class="gray-set">
										<div class="flex-1 bg-gray-100 ht-100p p-3" id="background-gray">.bg-gray-100</div>
								...
								<div class="table-responsive mg-t-20 mb-0">
									<table class="table main-table-reference text-nowrap mg-t-0 mb-0">
										<tbody>
											<tr>
												<td class="bg-gray-100 wd-20p" id="background-gray"><b>Classes</b></td>
												<td><code>class="bg-gray-[value]"</code></td>
											</tr>
											<tr>
												<td class="bg-gray-100 wd-20p" id="background-gray"><b>Values</b></td>
