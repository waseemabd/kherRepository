...
@section('content')
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0"
		...
		<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/4.jpg')}}">
		<div class="media-body me-3">
			<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
										...
										<div class="media d-block d-sm-flex">
											...
											<div class="media-body me-3">
												...
												<div class="media d-block d-sm-flex mg-t-25">
													<img alt=""
														class="main-img-user avatar-lg mg-b-20 mg-sm-b-0"
									...
									<figure class="highlight clip-widget" id="media-object02">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
		<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/9.jpg')}}">
		<div class="media-body me-3">
			<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
			...
			<div class="media d-block d-sm-flex mg-t-25">
				<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/8.jpg')}}">
				<div class="media-body me-3">
					<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
					Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
				</div>
							...
							<div class="card-body">
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt=""
												class="main-img-user avatar-lg mg-b-20 mg-sm-b-0 align-self-center"
									...
									<figure class="highlight clip-widget" id="media-object03">
										<pre><code class="language-markup"><script type="html-dashlead/script"><div class="media d-block d-sm-flex">
		<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0 align-self-center" src="{{asset('assets/img/faces/14.jpg')}}">
		<div class="media-body me-3">
			<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
		...
		<li class="media d-block d-sm-flex">
			<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/2.jpg')}}">
			<div class="media-body me-3">
				<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
				Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
			</div>
		...
		<li class="media d-block d-sm-flex mg-t-25">
			<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/12.jpg')}}">
			<div class="media-body me-3">
				<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
				Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
			</div>
		...
		<li class="media d-block d-sm-flex mg-t-25">
			<img alt="" class="main-img-user avatar-lg mg-b-20 mg-sm-b-0" src="{{asset('assets/img/faces/7.jpg')}}">
			<div class="media-body me-3">
				<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
				Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
			</div>
