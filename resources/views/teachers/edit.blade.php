                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary btn-sm" href="{{ route('teachers.index') }}">{{trans('Teachers/Teachers.Back')}}</a>
                        </div>
                    </div><br>
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>{{trans('Teachers/Teachers.user role')}}</strong>
                    ...
                    <div class="mg-t-30">
                        <button class="btn btn-main-primary pd-x-20" type="submit">{{trans('Teachers/Teachers.update')}}</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
